...
Using C# to implement multiple layer perceptron simulator. Learning algorithm can refer to [this](https://en.wikipedia.org/wiki/Perceptron#Learning_algorithm) Wikipedia page.
